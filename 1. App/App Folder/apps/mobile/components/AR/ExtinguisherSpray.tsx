/**
 * ExtinguisherSpray.tsx
 * Realistic Volumetric CO2 Cryogenic Fog & Powder Mist Stream.
 * TypeScript port of ML Model/mobile_virtual_fire/src/components/ExtinguisherSpray.js
 *
 * Renders high-pressure expanding fog clouds, cryogenic vapor haze, and realistic
 * billow dynamics without harsh borders or bubble artifacts.
 */

import React from 'react';
import { StyleSheet, View } from 'react-native';
import { SprayParticle } from '../../engine/FireEffectEngine';
...
export const ExtinguisherSpray: React.FC<ExtinguisherSprayProps> = ({
  particles = [],
  active = false,
}) => {
